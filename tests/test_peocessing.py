...
data = [
    ...
    {"date": "2024-01-05T12:00:00.000000", "state": "EXECUTED", "amount": 150},
]
...
def test_filter_by_state(test_data, state, expected_length):
    """Тестирование функции, которая возвращает новый список словарей по указанному ключу"""
...
def test_sort_by_date(test_data, reverse_order, expected_dates):
    """Тестирование функции, которая сортерует список банковских операций по дате"""
