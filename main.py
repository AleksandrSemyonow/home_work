...
from src.filtering_operations import filtered_banking_description, filtered_transactions_by_description
...
def main():
    ...
    while True:
        ...
        if answer_1 == "1":
            ...
            operations = load_transaction(r"data\operations.json")
            break
        elif answer_1 == "2":
            print("Для обработки выбран CSV-файл")
            operations = read_csv_file(r"data\transactions.csv")
            break
        elif answer_1 == "3":
            print("Для обработки выбран Excel-файл")
            operations = read_excel_file(r"data\transactions_excel.xlsx")
            break
        else:
    ...
    while True:
        ...
        if filter3 == "да":
            ...
            filtered_operations_dy_descr = filtered_transactions_by_description(filtered_operations_dy_currency, user_search)
            break
        elif filter3 == "нет":
    ...
    for operation in filtered_operations_dy_descr:
        date = get_data(operation.get("date"))
